...
var navigate = function (event) {
    ...
    window.location.href = "/public/list/" + page + "?search=" + search + "&order=" + order + "&categoria=" + categoria
}
...
function doSearch() {
    ...
    order = $("#order").val()
    var categoria = $("#categoria").val()
    window.location.href = "/public/list/1?search=" + search + "&order=" + order + "&categoria=" + categoria
}
